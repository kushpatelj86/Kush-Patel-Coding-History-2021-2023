...
public class HashTableDoubleHashing<K extends SecondaryHash, V> extends HashTableOpenAdressingBase<K, V>
{
    ...
    //adjust the capacity until it is a prime number. The reason being
