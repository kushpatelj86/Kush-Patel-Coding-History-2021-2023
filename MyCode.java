...
public class MyCode
{
    ...
    public static void main(String[] args) 
    {
        ...
        System.out.println("Str1 == Str2? " + (Str1 == Str2)); // str1 is a object and str2 is a reference
        System.out.println("Str1 == Str3? " + (Str1 == Str3)); // str1 is a object and str3 is a object
        System.out.println("Str1.equals(Str2)? " + Str1.equals(Str2)); // str1 is a object str2 is a object
        ...
        System.out.println(r.removeSpaces("Hello Word")); 
...
public int getCount(int number)   //// non for loop version
  {
    ...
    return count;
        ...
        public void printEvenMultiple(int value, int howMany)
        {
            ...
            while(evenMult == 0 && numTimes <= howMany)
            {
